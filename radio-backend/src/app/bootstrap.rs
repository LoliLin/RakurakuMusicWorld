...
pub async fn run() -> anyhow::Result<()> {
    ...
    // 本地主机模型安全日志：本地回路访问者自动为管理员，远程提权已彻底废除。
    tracing::info!("Access security model: local loopback requests are granted host/admin automatically; remote admin claiming is disabled.");
